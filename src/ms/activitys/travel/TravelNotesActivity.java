...
public class TravelNotesActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.new_long_comment);
		...
		pkid = this.getIntent().getExtras().getString("pkid");
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
			TravelNotesActivity.this.setResult(1, getIntent());
		...
		try{
			...
			mImageView.setOnCreateContextMenuListener(new OnCreateContextMenuListener() {
				...
				public void onCreateContextMenu(ContextMenu arg0, View arg1,
					...
					if(!fileUrl.equals(""))
					{
						arg0.setHeaderTitle(TravelNotesActivity.this.getString(R.string.image_menu_lable));
						arg0.add(0, 0, 0, TravelNotesActivity.this.getString(R.string.image_view_lable)).setIcon(R.drawable.tupian_btn);
						arg0.add(0, 1, 0, TravelNotesActivity.this.getString(R.string.image_replace_lable)).setIcon(R.drawable.tupian_btn);
						arg0.add(0, 2, 0, TravelNotesActivity.this.getString(R.string.phone_screen_label)).setIcon(R.drawable.tupian_btn);
						arg0.add(0, 3, 0, TravelNotesActivity.this.getString(R.string.image_dellent_lable)).setIcon(R.drawable.delete_icon);
			...
			contText.addTextChangedListener(new TextWatcher() {
	            ...
	            public void afterTextChanged(Editable s) {
	            	try{
		                ...
		                tvCmtLabel.setText(TravelNotesActivity.this.getString(R.string.travel_lable_20)+number);
		                ...
		                if (temp.length() > num) {
		                    ...
		                    makeText(TravelNotesActivity.this.getString(R.string.travel_lable_21));
		                }
	            	}catch(Exception ex){
	            		ex.printStackTrace();
	            	}
			...
			tvCmtLabel =(TextView)findViewById(R.id.tvLabel);
...
//			linearProgress.setVisibility(View.VISIBLE);
			...
			EditText titleText = (EditText)findViewById(R.id.etTitle);
			final String lvtitle = titleText.getText().toString();
...
//							makeText("filesize==="+filesize);
						...
						if(tag)
						{
							boolean bf = api.uploadFiles(params,files,"sendTravelNotes");
							msg.obj = bf;
						}
						else
						{
...
//				{
//					pd.dismiss();
//					TravelNotesActivity.this.setResult(RESULT_OK, getIntent());
//					TravelNotesActivity.this.finish();
//					makeText("发送成功");
//				}
//				else
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				if(bf)
				{
					...
					TravelNotesActivity.this.setResult(1, getIntent());
					TravelNotesActivity.this.finish();
					makeText(TravelNotesActivity.this.getString(R.string.send_msg_session_lable));
				} else {
					pd.dismiss();
					makeText(TravelNotesActivity.this.getString(R.string.travel_lable_23));
				}
				break;
			default:
