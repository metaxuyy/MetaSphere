...
import ms.activitys.hotel.GroupContactActivity;
...
//	private String[] mImage;
	...
	public GroupContactAdapter(Context context,List<Map<String,Object>> data,int resource,int resource1,int resource2,String[] from, int[] to,MyApp myapp,String isYn,String gids){
...
//				viewHolder2.imgview = (ImageView)convertView.findViewById(R.id.img_icon);
			...
			case TYPE_3:
				...
				viewHolder3.contactitem_select_cb = (CheckBox)convertView.findViewById(R.id.contactitem_select_cb);
		...
		case TYPE_1:
			...
			viewHolder1.et1.setText(GroupContactActivity.instance.mykey);
			viewHolder1.et1.setSelection(GroupContactActivity.instance.mykey.length());
			viewHolder1.et1.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start,
					...
					{
						if(!str.equals(GroupContactActivity.instance.mykey))
						{
							GroupContactActivity.instance.mykey = str;
//							GroupContactActivity.instance.getMyStoreListDatas(str);
							GroupContactActivity.instance.getMyStoreListDatas(str,isYn);
						}
					}
					else
					{
						if(!str.equals(GroupContactActivity.instance.mykey))
						{
							GroupContactActivity.instance.mykey = "";
//							GroupContactActivity.instance.getMyStoreListDatas();
							GroupContactActivity.instance.getMyFriendDatas(isYn);
						}
					}
				}
...
//			}
		...
		case TYPE_3:
			...
			if(gids != null && !gids.equals(""))
			{
				...
				{
					viewHolder3.contactitem_select_cb.setChecked(true);
					viewHolder3.contactitem_select_cb.setClickable(false);
				}
			}
			break;
		}
