...
import ms.activitys.hotel.ForwardContactActivity;
...
//	private String[] mImage;
	...
	public ForwardContactAdapter(Context context,List<Map<String,Object>> data,int resource,int resource1,int resource2,String[] from, int[] to,MyApp myapp,String isYn){
...
//		String storeName = (String)dataSet.get("storeName");
		...
		case TYPE_1:
			...
			viewHolder1.et1.setText(ForwardContactActivity.instance.mykey);
			viewHolder1.et1.setSelection(ForwardContactActivity.instance.mykey.length());
			viewHolder1.et1.addTextChangedListener(new TextWatcher() {
				...
				public void onTextChanged(CharSequence s, int start,
					...
					{
						if(!str.equals(ForwardContactActivity.instance.mykey))
						{
							ForwardContactActivity.instance.mykey = str;
//							ForwardContactActivity.instance.getMyStoreListDatas(str);
							ForwardContactActivity.instance.getMyStoreListDatas(str,isYn);
						}
					}
					else
					{
						if(!str.equals(ForwardContactActivity.instance.mykey))
						{
							ForwardContactActivity.instance.mykey = "";
//							ForwardContactActivity.instance.getMyStoreListDatas();
							ForwardContactActivity.instance.getMyFriendDatas(isYn);
						}
					}
				}
			...
			break;
		case TYPE_2:
			viewHolder2.textview.setText(mContext.getString(R.string.hotel_label_174));
