...
public final class SecureChatSslContextFactory {
    ...
    public SecureChatSslContextFactory(Context context)
    {
...
//            File file = new File("file:///android_asset/cert.bks");
            InputStream in = context.getResources().getAssets().open("cert.keystore");//new FileInputStream(file);
            ks.load(in,SecureChatKeyStore.getKeyStorePassword());
...
//            KeyStore ks = KeyStore.getInstance("BKS");
////            File file = new File("file:///android_asset/cert.bks");
//            InputStream in = context.getResources().getAssets().open("cert.bks");//new FileInputStream(file);
//            ks.load(in,SecureChatKeyStore.getKeyStorePassword());
////            ks.load(SecureChatKeyStore.asInputStream(),
////                    SecureChatKeyStore.getKeyStorePassword());
//
